...
private:
	...
	int16_t m_freqEstSum;					// суммарная частота с обоих корреляторов
	...
	bool m_estDone;							// флаг обнаружения сигнала коррелятором

	DDS m_freqCorrector;					// генератор для коррекции частоты после обнаружения сигнала корреляторами
