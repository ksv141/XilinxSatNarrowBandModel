...
xip_fir_v7_2_rld_packet fir_real_summator_rld;		// reload-пакет для установки коэффициента a0
xip_fir_v7_2_cnfg_packet fir_real_summator_cnfg_rld;	// config-пакет для установки коэффициента a0
xip_array_uint* fir_real_summator_cnfg_fsel;
double fir_real_summator_coeff = 0;					// начальное значение коэффициента a0
